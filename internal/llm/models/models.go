...
var SupportedModels = []Model{
	...
	{ID: "deepseek-ai/deepseek-v4-flash", Provider: ProviderNvidiaNIM, DisplayName: "DeepSeek V4 Flash", ContextWindow: 128000, DefaultMaxTokens: 8192, CostPer1MIn: 0.00, CostPer1MOut: 0.00},
	{ID: "meta/llama-3.3-70b-instruct", Provider: ProviderNvidiaNIM, DisplayName: "Llama 3.3 70B", ContextWindow: 128000, DefaultMaxTokens: 4096, CostPer1MIn: 0.00, CostPer1MOut: 0.00},
	{ID: "mistralai/mistral-large", Provider: ProviderNvidiaNIM, DisplayName: "Mistral Large", ContextWindow: 128000, DefaultMaxTokens: 8192, CostPer1MIn: 0.00, CostPer1MOut: 0.00},
